...
def prediction_nltk(question_in):
    ...
    # Constantes
#    NLTK_MODEL = 'app_models/model_RandomForestClassifier_NLTK_stemmer.pkl'
    NLTK_MODEL = 'app_models/model_RandomForestClassifier_NLTK_stemmer.sav'    
...
def prediction_use(question_in):
    ...
    # Constantes
#    USE_MODEL = 'app_models/model_RandomForestClassifier_USE.pkl'
